...
import { createCARTTree } from './shared/cart-algorithm.js';
import { DataTypeDetector, recommendAlgorithm } from './shared/data-type-detection.js';
import { globalCache, getCachedPrediction, setCachedPrediction } from './shared/caching-system.js';
import { processDataOptimized } from './shared/memory-optimization.js';
/**
...
class DecisionTree {
    ...
    createTree(data) {
        if (this.algorithm === 'cart') {
            ...
            // Use ID3 algorithm
            return createTree(data, this.target, this.features, this.config.maxDepth, this.config.minSamplesSplit);
        }
    }
    /**
